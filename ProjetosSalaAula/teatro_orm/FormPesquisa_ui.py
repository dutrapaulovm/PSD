...
class Ui_FormPesquisa(object):
    def setupUi(self, FormPesquisa):
        ...
        self.EdtValorPesquisa = QLineEdit(FormPesquisa)
        self.EdtValorPesquisa.setObjectName(u"EdtValorPesquisa")

        self.horizontalLayout.addWidget(self.EdtValorPesquisa)
        ...
        self.tableResultado.setSelectionMode(QAbstractItemView.ExtendedSelection)
